...
public abstract class AbstractEMFacade<T> {
    //typ generyczny, abstrakcyjny na której podstawie każdą z fasad będziemy w stanie przygotować
    //chodzi o wzorzec projektowy fasady, która przesłania wszystkie operacje na Entity Managerze
    ...
    // To z kolei wymusza zastosowanie dla takiej metody @TransactionAttribute i @RolesAllowed, i to jest właśnie cel.
