package p.lodz.it.spjava.e13.ges.rest.exceptions;
...
public class AppBaseException extends WebApplicationException {
    ...
    protected final static String ERROR_UNKNOWN = "ERROR.GENERAL.UNKNOWN";
    ...
    public static AppBaseException createForAccessDeny(Throwable cause) {
        return new AppBaseException(Response.Status.FORBIDDEN, ERROR_ACCESS_DENIED, cause);
    }

    public static AppBaseException createForAccessDeny() {
    ...
    public static AppBaseException createForOptimisticLock() {
        return new AppBaseException(Response.Status.CONFLICT, ERROR_OPTIMISTIC_LOCK);
    }

    public static AppBaseException createForOptimisticLock(OptimisticLockException cause) {
        return new AppBaseException(Response.Status.CONFLICT, ERROR_OPTIMISTIC_LOCK, cause);
    }
