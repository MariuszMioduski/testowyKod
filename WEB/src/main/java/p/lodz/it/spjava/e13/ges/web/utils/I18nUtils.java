...
public class I18nUtils {
    private final static String messagesBundlePath = "i18n.messages"; // It could be parametrized though
    ...
    public static boolean isInternationalizationKeyExist(String key) {
        try {
            ...
            if (message.length() >= 2)  //komunikat musi mieć przynajmniej dwa znaki
                return true;
